...
const BLOG = {
  AUTHOR: 'Hong Guo', // 作者
  BIO: 'Black Hole Physics, General Relativity and Gravitational Waves', // 作者简介
  LINK: 'https://www.worldhorizon.site', // 网站地址
  KEYWORDS: 'Notion, Website, Black hole Physics, Gravitational waves, General relativity', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '4f558d38a16f4528b4776ef9758d1c3e', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'gravhguo@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Insider the World', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Black Hole Physics, General Relativity and Gravitational Waves', // 站点描述，被notion中的页面描述覆盖
